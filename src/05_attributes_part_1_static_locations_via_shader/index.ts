...
export default async function _005_attributes_part_1_static_locations_via_shader(context: WebGL2RenderingContext) {

    const glShaderInterface = await configureShaders(context, './05_attributes_part_1_static_locations_via_shader', 'vSource', 'fSource');
    //^----Attributes----^\\
    /**
